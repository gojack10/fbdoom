...
default_t	defaults[] =
{
    ...
    {"sfx_volume",&snd_SfxVolume, 75},
    {"music_volume",&snd_MusicVolume, 75},
...
void M_LoadDefaults (void)
{
	...
	*defaults[i].location = defaults[i].defaultvalue;
    ...
    // Normalize volume values: config stores 0-127, menu slider uses 0-15
    if (snd_SfxVolume > 15) snd_SfxVolume = (snd_SfxVolume + 4) / 8;
    if (snd_MusicVolume > 15) snd_MusicVolume = (snd_MusicVolume + 4) / 8;
